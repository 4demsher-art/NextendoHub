#---------------------------------------------------------------------------------
# NextendoHub for Nintendo Switch homebrew (.nro)  —  devkitPro / libnx
#
# Build:   (inside devkitPro MSYS2, or the devkitpro/devkita64 Docker image)
#            make
#          -> NextendoHub.nro   (copy to sdmc:/switch/ and launch from hbmenu)
#
# Needs:   devkitA64, libnx, and the switch-curl / switch-mbedtls portlibs:
...
# curl (with mbedTLS backend) + deps, then libnx
